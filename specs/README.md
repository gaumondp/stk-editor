# SmplTrek Kit Builder — Specs & TODO

Lightweight specs + a tracked TODO to drive V1 development. Source of truth:
...
Tracked in [TODO.md](TODO.md) — grouped by workstream, each item mapped to a
spec. Start at [**Phase 1 · Foundation**](TODO.md#phase-1--foundation) and work
down. Recommended next-up items are tagged `▶`.
