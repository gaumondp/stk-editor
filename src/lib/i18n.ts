...
'help.about': 'About',
                                                 ...
                                                 'about.compatibility': 'Sonicware documents SmplTrek-created STK data for ELZ_1 Play; STK Forge has not validated that workflow.',
...
'help.about': 'À propos',
                                                  ...
                                                  'about.compatibility': 'Sonicware documente des données STK créées avec SmplTrek pour ELZ_1 Play ; STK Forge n’a pas validé ce flux.',
...
const ja: Record<string, string> = {
	'app.title': 'STK Forge', 'welcome.description': '編集可能なキットを作成し、Sonicware機器向けの .stk ファイルをコンパイルします。', 'welcome.supported': 'Sonicware SmplTrek ファームウェア 3.2 でのみ動作確認済みです。', 'welcome.elz1': 'Sonicware は ELZ_1 Play 用の STK データを公開していますが、STK Forge では未検証です。', 'welcome.hint': 'WAVをパッドへドラッグして割り当て • Cmd/Ctrl+クリックでサンプルを解除 • ダブルクリックで試聴 • F1でヘルプを表示',
	'menu.new': '新規キット', 'menu.kit': 'キット', 'menu.open': 'キットを開く…', 'menu.open_compiled': 'コンパイル済みキットを開く…', 'menu.save': '保存', 'menu.save_as': '名前を付けて保存…', 'menu.kit_information': 'キット情報…', 'menu.find_missing': '見つからないオーディオファイルを検索…', 'menu.close': 'キットを閉じる', 'menu.quit': 'アプリケーションを終了', 'menu.compile': 'キットをコンパイル', 'menu.compile_file': '.stk にコンパイル…', 'menu.export': '書き出し', 'menu.export_sd': 'SDカードへ書き出し…', 'menu.export_full': 'JSON付きでキットを書き出し…', 'menu.undo': '元に戻す', 'menu.redo': 'やり直す', 'menu.about': 'STK Forge について', 'menu.recent': '最近のキット…', 'menu.help': 'ヘルプ', 'menu.language': '言語', 'menu.no_recent': '最近使用したキットはありません',
	...
	'about.build_time': 'ビルド日時 {time}', 'about.developed_by': '開発：Patrick Gaumond', 'about.github': 'GitHubリポジトリ', 'about.copy_diagnostics': '診断情報をコピー', 'about.diagnostics_copied': 'コピーしました', 'about.title': 'STK Forge', 'about.version': 'v{version} • Sonicware SmplTrek ファームウェア 3.2 でのみ動作確認済み', 'about.description': '編集可能なキットを作成し、.stkファイルをコンパイルして、コンパイル済みキットをローカルで検査します。', 'about.compatibility': 'Sonicware は SmplTrek で作成した STK データを ELZ_1 Play で使えると案内していますが、STK Forge では未検証です。', 'about.license': 'ライセンス：MIT', 'about.repo': 'ローカル専用アプリケーション', 'about.disclaimer': '独立したプロジェクトです。使用する正確なハードウェアとファームウェアで、必ず各出力を確認してください。', 'about.ok': 'OK',
	...
	'pad.parameters_title': 'パッドパラメーター', 'pad.parameter_volume': '音量', 'pad.parameter_pan': 'パン', 'pad.parameter_pitch': 'ピッチ', 'pad.parameter_fx_send': 'FXセンド', 'pad.parameter_value': '値', 'pad.parameter_value_for': '{parameter}の値', 'pad.parameter_drag_hint': 'ノブを上下にドラッグするか、下に値を入力してください。', 'pad.parameter_selected': 'パッド {pad} を選択中', 'pad.parameter_pan_center': '中央', 'pad.parameter_pan_left': '左 {value}', 'pad.parameter_pan_right': '右 {value}', 'pad.parameter_select_audio': 'サンプルが割り当てられたパッドを選択するとパラメーターを編集できます。', 'pad.parameter_invalid': '{min} から {max} の整数を入力してください。',
	'theme.switch_to_light': 'ライトテーマを使用', 'theme.switch_to_dark': 'ダークテーマを使用', 'display.scale': 'インターフェースの拡大率',
	'sd_reader.title': 'SDカードリーダー', 'sd_reader.open': 'SDカードを読み込む', 'sd_reader.close': '閉じる', 'sd_reader.choose_another': '別のカードを選択…', 'sd_reader.valid': '有効なSmplTrekカード', 'sd_reader.incomplete': '不完全なSmplTrekフォルダー', 'sd_reader.invalid': '選択した場所にSmplTrekフォルダーがありません', 'sd_reader.selected_path': '選択した場所', 'sd_reader.projects': 'プロジェクト', 'sd_reader.no_projects': 'プロジェクトが見つかりません', 'sd_reader.presets': 'プリセット', 'sd_reader.preset_audio_drum': 'AUDIO/DRUM', 'sd_reader.preset_audio_inst': 'AUDIO/INST', 'sd_reader.preset_kit': 'KIT', 'sd_reader.audio_files': 'オーディオファイル', 'sd_reader.no_audio_files': 'オーディオファイルが見つかりません', 'sd_reader.search_audio': 'オーディオファイルを絞り込み…', 'sd_reader.missing_directories': '見つからないディレクトリ', 'sd_reader.files_count': '{count} 件',
};
