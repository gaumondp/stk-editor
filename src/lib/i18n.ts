...
const en: Record<string, string> = {
	...
	'explorer.status.ready': 'Ready',
	'explorer.status.convertible': 'Will be converted',
	'explorer.status.unreadable': 'Incompatible',
	'explorer.legend.title': 'Compatibility',
	'explorer.legend.ready': 'Ready',
	'explorer.legend.convertible': 'Converted on compile',
	'explorer.legend.unreadable': 'Incompatible',
	'explorer.legend.note': 'Colours reflect how the file reads, not a guarantee the conversion will succeed.',
	...
	'compile.unreadable.title': 'Some WAV files cannot be compiled',
	'compile.unreadable.padLine': 'Pad {pad}: {file} — {reason}',
	'compile.unreadable.emptyPads': 'Pads {pads} will be empty',
	'compile.unreadable.compileWithout': 'Compile without them',
	'compile.unreadable.cancel': 'Cancel',
...
const fr: Record<string, string> = {
	...
	'explorer.compatible': 'Compatible',
	'explorer.status.ready': 'Prêt',
	'explorer.status.convertible': 'Sera converti',
	'explorer.status.unreadable': 'Incompatible',
	'explorer.legend.title': 'Compatibilité',
	'explorer.legend.ready': 'Prêt',
	'explorer.legend.convertible': 'Converti à la compilation',
	'explorer.legend.unreadable': 'Incompatible',
	'explorer.legend.note':
		'Les couleurs reflètent une analyse de lecture du fichier, pas une garantie que la conversion réussira.',
	...
	'compile.unreadable.title': 'Certains fichiers WAV ne peuvent pas être compilés',
	'compile.unreadable.padLine': 'Pad {pad} : {file} — {reason}',
	'compile.unreadable.emptyPads': 'Les pads {pads} seront vides',
	'compile.unreadable.compileWithout': 'Compiler sans',
	'compile.unreadable.cancel': 'Annuler',
...
const ja: Record<string, string> = {
	...
	'explorer.status.ready': '準備完了',
	'explorer.status.convertible': '変換されます',
	'explorer.status.unreadable': '非対応',
	'explorer.legend.title': '互換性',
	'explorer.legend.ready': '準備完了',
	'explorer.legend.convertible': 'コンパイル時に変換',
	'explorer.legend.unreadable': '非対応',
	'explorer.legend.note': '色はファイルの読み取り解析を示すもので、変換の成功を保証するものではありません。',
	'explorer.search': '検索',
	'explorer.play': '試聴',
	'explorer.stop': '試聴を停止',
	'explorer.volume': '音量',
	...
	'compile.warnings': '警告',
	'compile.unreadable.title': '一部の WAV ファイルはコンパイルできません',
	'compile.unreadable.padLine': 'パッド {pad}：{file} — {reason}',
	'compile.unreadable.emptyPads': 'パッド {pads} は空になります',
	'compile.unreadable.compileWithout': 'これらを除いてコンパイル',
	'compile.unreadable.cancel': 'キャンセル',
